...
W = [
        ...
        2e-1, 5e0, 5e0,      # Base angular velocity weights
    ]
...
config_cost = MPCCostConfig(
    ...
    gait_name="",
    W_e_base=__init_np(W_e, 15.),
    W_base=__init_np(W, 100.),
    W_joint=__init_np(HSE_SCALE + [0.1] * len(HSE_SCALE), 10.),
    W_e_joint=__init_np(HSE_SCALE + [0.001] * len(HSE_SCALE), 0.1),
    W_acc=__init_np(HSE_SCALE, 1.e-3),
    W_swing=__init_np([1.5e4] * n_feet),
    W_eeff_ori=__init_np([5e1] * n_feet),
